  ...
  [487],
  {
    ...
    4723: function (e, t, r) {
      ...
      n.addEventListener &&
        ...
        n.removeEventListener && n.removeEventListener("p", a, !1);
      var u = i,
        l = "ontouchstart" in n,
        s = "TouchEvent" in n,
        c = l || (s && o("(any-pointer: coarse)").matches),
        f = (n.navigator.maxTouchPoints || 0) > 0 || c,
        p = n.navigator.userAgent || "",
        d =
          o("(pointer: coarse)").matches &&
          /iPad|Macintosh/.test(p) &&
          Math.min(n.screen.width || 0, n.screen.height || 0) >= 768,
        y =
          (o("(pointer: coarse)").matches ||
            (!o("(pointer: fine)").matches && l)) &&
          !/Windows.*Firefox/.test(p),
        h =
          o("(any-pointer: fine)").matches ||
          o("(any-hover: hover)").matches ||
          d ||
          !l,
        v = f && (h || !y) ? "hybrid" : f ? "touchOnly" : "mouseOnly";
    },
    775: function (e) {
      function t(e, t) {
        (e.onload = function () {
        ...
        try {
          return (function e(i, a) {
            ...
            if (i && a && "object" == typeof i && "object" == typeof a) {
              ...
              if (Array.isArray(i)) {
                if ((u = i.length) != a.length) return !1;
                for (l = u; 0 != l--; ) if (!e(i[l], a[l])) return !1;
                return !0;
              }
              ...
              if (o && ArrayBuffer.isView(i) && ArrayBuffer.isView(a)) {
                if ((u = i.length) != a.length) return !1;
                for (l = u; 0 != l--; ) if (i[l] !== a[l]) return !1;
                return !0;
              }
    ...
    6934: function (e, t, r) {
      var n = r(3293).e,
        o = r(1552).Z;
      e.exports = n([{ key: "file", canPlay: o.canPlay, lazyPlayer: o }]);
    },
    2119: function (e, t, r) {
      "use strict";
      function n(e) {
      ...
      var o,
        ...
        a = (o = r(5720)) && o.__esModule ? o : { default: o },
        u = r(1262),
        l = r(3301);
      function s() {
        ...
        var t,
          ...
          u =
            ...
            function () {
              ...
              return (e = r) && ("object" === n(e) || "function" == typeof e)
                ? e
                : d(this);
            });
        function s() {
          ...
          for (var t = arguments.length, r = Array(t), n = 0; n < t; n++)
            r[n] = arguments[n];
          return (
            h(d((e = u.call.apply(u, [this].concat(r)))), "mounted", !1),
            h(d(e), "isReady", !1),
            h(d(e), "isPlaying", !1),
            h(d(e), "isLoading", !0),
            h(d(e), "loadOnReady", null),
            h(d(e), "startOnPlay", !0),
            h(d(e), "seekOnPlay", null),
            h(d(e), "onDurationCalled", !1),
            h(d(e), "handlePlayerMount", function (t) {
              if (e.player) {
                e.progress();
                return;
              }
            ...
            h(d(e), "getInternalPlayer", function (t) {
              return e.player ? e.player[t] : null;
            }),
            h(d(e), "progress", function () {
            ...
            h(d(e), "handlePause", function (t) {
              (e.isPlaying = !1), e.isLoading || e.props.onPause(t);
            }),
            h(d(e), "handleEnded", function () {
              var t = e.props,
                r = t.activePlayer,
                n = t.loop,
                o = t.onEnded;
            ...
            h(d(e), "handleError", function () {
              var t;
              (e.isLoading = !1), (t = e.props).onError.apply(t, arguments);
            }),
            h(d(e), "handleDurationCheck", function () {
      ...
      (t.default = v),
        ...
        h(v, "propTypes", u.propTypes),
        h(v, "defaultProps", u.defaultProps);
    },
    9385: function (e, t, r) {
      "use strict";
      function n(e) {
        ...
        h = (function (e) {
          ...
          function h() {
            ...
            for (var t = arguments.length, r = Array(t), n = 0; n < t; n++)
              r[n] = arguments[n];
            return (
              p(c((e = a.call.apply(a, [this].concat(r)))), "mounted", !1),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (!o.default.isValidElement(n)) {
                    ...
                    if (y[r]) {
                      this.setState({ image: y[r] });
                      return;
                    }
                    return (
                      this.setState({ image: null }),
                      window
                        .fetch(i.replace("{url}", r))
                        .then(function (e) {
                          return e.json();
                        })
                        .then(function (e) {
            ...
            (function (r) {
              ...
              function E() {
                ...
                for (var a = arguments.length, c = Array(a), f = 0; f < a; f++)
                  c[f] = arguments[f];
                return (
                  O(g((r = w.call.apply(w, [this].concat(c)))), "state", {
                  ...
                  O(g(r), "seekTo", function (e, t, n) {
                    if (!r.player) return null;
                    r.player.seekTo(e, t, n);
                  }),
                  O(g(r), "handleReady", function () {
                    r.props.onReady(g(r));
                  }),
                  O(
                    g(r),
                  ...
                  O(
                    ...
                    (0, i.default)(function (e) {
                      return (0, l.omit)(r.props, j);
                    })
                  ),
                  O(g(r), "renderActivePlayer", function (e) {
                    if (!e) return null;
      ...
      (t.FLV_EXTENSIONS = w),
        (t.canPlay = {
          ...
          soundcloud: function (e) {
            return a.test(e) && !m.test(e);
          },
          vimeo: function (e) {
            return u.test(e) && !g.test(e) && !P.test(e);
          },
          facebook: function (e) {
          ...
          file: function e(t) {
            if (t instanceof Array) {
              ...
              try {
                for (i.s(); !(r = i.n()).done; ) {
                  var a = r.value;
                  if (("string" == typeof a && e(a)) || e(a.src)) return !0;
                }
              } catch (e) {
                i.e(e);
              } finally {
    ...
    1552: function (e, t, r) {
      ...
      var y = "undefined" != typeof navigator,
        ...
        v =
          y &&
          (/iPad|iPhone|iPod/.test(navigator.userAgent) || h) &&
          !window.MSStream,
        b =
          y &&
        ...
        P = (function (e) {
          ...
          function h() {
            ...
            return (
              d(
                f((e = y.call.apply(y, [this].concat(r)))),
                "onReady",
                function () {
                  var t;
                ...
                value: function (e) {
                  return (
                    ...
                    (!v &&
                      ...
                      (a.HLS_EXTENSIONS.test(e) || g.test(e)))
                  );
                },
              },
              {
      ...
      (t.Z = P),
        d(P, "displayName", "FilePlayer"),
        d(P, "canPlay", a.canPlay.file);
    },
    1262: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      var n,
        o = (n = r(5608)) && n.__esModule ? n : { default: n },
        i = o.default.string,
        a = o.default.bool,
        u = o.default.number,
        l = o.default.array,
        ...
        y = {
          ...
          fallback: d,
          oEmbedUrl: i,
          wrapper: s([i, p, c({ render: p.isRequired })]),
          config: c({
    ...
    265: function (e, t) {
      ...
      let r = [
        ...
        n = (() => {
          ...
          for (let n of r) {
            let r = n?.[1];
            if (r in document) {
              for (let [r, o] of n.entries()) t[e[r]] = o;
              return t;
            }
          }
          return !1;
        ...
        i = {
          ...
          exit: () =>
            new Promise((e, t) => {
              ...
              i.on("change", r);
              let o = document[n.exitFullscreen]();
      ...
      Object.defineProperties(i, {
        isFullscreen: { get: () => !!document[n.fullscreenElement] },
        element: {
          enumerable: !0,
          get: () => document[n.fullscreenElement] ?? void 0,
        },
        isEnabled: {
          enumerable: !0,
          get: () => !!document[n.fullscreenEnabled],
        },
      }),
        n || (i = { isEnabled: !1 }),
        (t.Z = i);
