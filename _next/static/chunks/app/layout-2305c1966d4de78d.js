(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    256: function (e, n, t) {
      Promise.resolve().then(t.bind(t, 4024)),
        Promise.resolve().then(t.t.bind(t, 184, 23));
    },
    184: function () {},
    4024: function (e, n, t) {
      "use strict";
      ...
      function d({ beforeSend: e, debug: n = !0, mode: t = "auto" }) {
        return (
          (0, r.useEffect)(() => {
            !(function (e = { debug: !0 }) {
              var n;
              ...
              (r.src = t),
                ...
                r.setAttribute("data-sdkv", "1.1.1"),
                (r.onerror = () => {
                  let e = l()
                    ? "Please check if any ad blockers are enabled and try again."
                    : "Be sure to enable Web Analytics for your project and deploy again. See https://vercel.com/docs/analytics/quickstart for more information.";
                  console.log(
                    `[Vercel Web Analytics] Failed to load script from ${t}. ${e}`
                  );
                }),
                l() && !1 === e.debug && r.setAttribute("data-debug", "false"),
                document.head.appendChild(r);
            })({ beforeSend: e, debug: n, mode: t });
          }, [e, n, t]),
          null
        );
      }
